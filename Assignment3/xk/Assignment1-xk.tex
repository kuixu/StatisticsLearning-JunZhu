...
\begin{figure}
\centering
\subfigure[Epoch 100]{\includegraphics[width=6cm]{imgs/100_learn.png}}
\subfigure[Epoch 200]{\includegraphics[width=6cm]{imgs/200_learn.png}}
\subfigure[Epoch 1000]{\includegraphics[width=6cm]{imgs/1000_learn.png}}
\vskip3ex
\subfigure[Epoch 1200]{\includegraphics[width=6cm]{imgs/1200_learn.png}}
\subfigure[Epoch 1400]{\includegraphics[width=6cm]{imgs/1400_learn.png}}
\subfigure[Epoch 1600]{\includegraphics[width=6cm]{imgs/1600_learn.png}}
\vskip3ex
\subfigure[Epoch 2000]{\includegraphics[width=6cm]{imgs/2000_learn.png}}
\subfigure[Epoch 2400]{\includegraphics[width=6cm]{imgs/2400_learn.png}}
\subfigure[Epoch 2800]{\includegraphics[width=6cm]{imgs/2800_learn.png}}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=16cm]{imgs/lb.png}
\end{center}
\caption{The figure shows the sampled data by three fixed point.}\label{datavis}
\end{figure}
% plot the cost and lowbound curve
